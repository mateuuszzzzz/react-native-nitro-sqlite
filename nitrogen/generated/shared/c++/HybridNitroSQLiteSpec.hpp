...
namespace margelo::nitro::rnnitrosqlite {
  ...
  class HybridNitroSQLiteSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual bool databaseExists(const std::string& dbName, const std::optional<std::string>& location) = 0;
      virtual void attach(const std::string& mainDbName, const std::string& dbNameToAttach, const std::string& alias, const std::optional<std::string>& location, std::optional<bool> plaintext) = 0;
      ...
      virtual double getAvailableMemory() = 0;
